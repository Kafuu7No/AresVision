...
const en = {
  ...
  explore: {
    ...
    pageDesc: 'This page is no longer a simple tab set. It acts as proof of platform value by presenting official Mars data assets, user data ingestion and review, and governance with quality traceability in one place.',
    tabDefault: 'Default Dataset',
    tabMy: 'My Data',
    tabGovernance: 'Governance',
    capabilityOfficialTitle: 'Official Data Assets',
    capabilityOfficialDesc: 'Show the platform-grade data foundation through source coverage, year coverage, standardization, and analysis-ready capability labels.',
    capabilityMyTitle: 'User Ingestion & Review',
    capabilityMyDesc: 'Turn upload management into a real workbench with validation, quality scoring, lifecycle states, and public contribution readiness.',
    capabilityGovernanceTitle: 'Governance & Quality Assessment',
    capabilityGovernanceDesc: 'Answer whether data are trustworthy, effective, traceable, and actually consumable by the analysis system.',
    defaultDataset: {
    ...
    upload: {
      ...
      subtitle: 'Supports OpenMARS (.nc) and MCD (.nc) formats. The system validates structure, temporal coverage, variable completeness, and grid compatibility, then exposes quality and lifecycle status in the ingestion workbench.',
    ...
    myData: {
      title: 'INGESTION ASSETS',
      count: ({ n }) => `${n} dataset${n !== 1 ? 's' : ''} total`,
      emptyHint: 'No datasets yet — drop a .nc file above to get started',
      workbenchTitle: 'USER INGESTION WORKBENCH',
      workbenchTotal: 'Ingested datasets',
      workbenchTotalDesc: 'Uploaded user files that have entered the managed ingestion pipeline.',
      workbenchAnalysis: 'Analysis-ready datasets',
      workbenchAnalysisDesc: 'Datasets that satisfy quality and effective-source conditions for downstream analysis.',
      workbenchPublic: 'Public-ready datasets',
      workbenchPublicDesc: 'Validated datasets that can enter the public contribution review workflow.',
      workbenchYears: 'Activated Mars years',
      workbenchYearsDesc: 'Mars years currently supported by personal or mixed effective sources.',
      workbenchBadge1: 'In public flow',
      workbenchBadge2: 'Ingestion failed',
      workbenchBadge3: 'Ready for analysis',
      latestReviewTitle: 'POST-UPLOAD QUALITY SCORECARD',
      detailReviewTitle: 'INGESTION SCORECARD & GOVERNANCE STATUS',
      cardType: 'Type',
      ...
      metricQuality: 'Quality score',
      metricAnalysis: 'Analysis condition',
      metricPublic: 'Public contribution',
      metricSource: 'Effective source zone',
      metricLifecycle: 'Lifecycle',
      metricMode: 'Source mode',
      qualityCardTitle: 'Quality scorecard',
      accessChecklistTitle: 'Access checklist',
      analysisCondition: 'Analysis use condition',
      publicCondition: 'Public contribution condition',
      lifecycleLabel: 'Lifecycle',
      storageZone: 'Current storage zone',
      readiness: {
        pass: 'Pass',
        fail: 'Fail',
      },
      publicState: {
        ...
        approved: 'Merged to public assets',
        blocked: 'Not ready',
      },
      lifecycle: {
        valid: 'Validated / managed',
        invalid: 'Validation failed',
        pending_review: 'Public review in progress',
        approved: 'Merged into public assets',
