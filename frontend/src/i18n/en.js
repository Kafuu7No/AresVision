...
const en = {
  ...
  explore: {
    ...
    upload: {
      ...
      subtitle: 'Supports OpenMARS (.nc) and MCD (.nc) formats. The system will automatically validate the data format and grid resolution.',
    ...
    governance: {
      ...
      subtitle: 'Asset overview, quality scoring and lineage traceability',
      scopeAll: 'All Assets',
      scopeMine: 'My Assets',
      ...
      assetList: 'DATA ASSET INVENTORY',
      colDataset: 'Dataset',
      colType: 'Source',
      colYear: 'Year',
      colLs: 'Ls coverage',
