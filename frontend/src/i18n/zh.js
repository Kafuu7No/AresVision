...
const zh = {
  ...
  explore: {
    ...
    pageDesc: '本页不再只是普通数据页，而是平台核心价值的证明面板：一侧展示官方火星数据资产，一侧承接用户数据接入与审核，同时给出质量评估与血缘治理能力。',
    tabDefault: '默认数据集',
    tabMy: '我的数据',
    tabGovernance: '治理总览',
    capabilityOfficialTitle: '官方数据资产',
    capabilityOfficialDesc: '展示平台官方数据底座的覆盖范围、统一标准与可分析能力，让评委一眼看出 AresVision 具备可复用、可训练、可对比的火星数据资产。',
    capabilityMyTitle: '用户数据接入与审核',
    capabilityMyDesc: '把上传区升级成接入工作台，强调校验、评分、生命周期和公共贡献条件，体现平台对外部数据的接入与治理能力。',
    capabilityGovernanceTitle: '数据治理与质量评估',
    capabilityGovernanceDesc: '从资产总览、质量分层、有效数据源和血缘溯源四个维度回答“这些数据是否可信、可追踪、可被分析系统真正使用”。',
    defaultDataset: {
    ...
    upload: {
      ...
      loginBtn: '登录',
      title: '上传火星观测数据',
      subtitle: '支持 OpenMARS (.nc) 和 MCD (.nc) 格式，系统将自动校验数据格式、时间覆盖、变量完整性与网格分辨率，并在接入工作台内展示质量评分与生效状态。',
    ...
    myData: {
      title: '接入资产清单 INGESTION ASSETS',
      count: ({ n }) => `共 ${n} 个数据集`,
      emptyHint: '还没有上传数据，拖拽 .nc 文件到上方区域开始',
      workbenchTitle: '用户数据接入与审核 USER INGESTION WORKBENCH',
      workbenchTotal: '已接入数据',
      workbenchTotalDesc: '用户上传后进入接入工作台，形成可持续治理的数据资产池。',
      workbenchAnalysis: '满足分析使用条件',
      workbenchAnalysisDesc: '满足质量评分与生效模式要求的数据，可直接进入分析流程。',
      workbenchPublic: '满足公共贡献条件',
      workbenchPublicDesc: '通过校验且可进入公开审核流程的数据数量，用于展示社区扩展潜力。',
      workbenchYears: '激活火星年',
      workbenchYearsDesc: '当前个人或混合数据源实际支撑的火星年数量。',
      workbenchBadge1: '公共流程中',
      workbenchBadge2: '接入失败',
      workbenchBadge3: '可分析',
      latestReviewTitle: '上传后质量评分卡',
      detailReviewTitle: '接入评分与治理状态',
      cardType: '类型',
      cardMarsYear: '火星年',
      cardLs: 'Ls',
      cardGrid: '网格',
      ...
      metricPublic: '公共贡献',
      metricSource: '生效源区',
      metricLifecycle: '生命周期',
      metricMode: '数据源模式',
      qualityCardTitle: '质量评分卡',
      accessChecklistTitle: '接入条件清单',
      analysisCondition: '分析使用条件',
      publicCondition: '公共贡献条件',
      lifecycleLabel: '生命周期',
      storageZone: '当前存储区',
      readiness: {
        pass: '满足',
